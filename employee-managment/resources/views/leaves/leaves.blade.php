...
<div class="flex justify-center bg-gray-100 py-10">
    <div class="w-full max-w-2xl bg-white p-8 rounded-2xl shadow-lg">
        ...
        <h2 class="text-2xl font-bold mb-6 text-center text-gray-800">Leaves</h2>
        ...
        <form action="{{ route('leaves.store') }}" method="POST" class="space-y-6">
            ...
            <!-- Reason -->
            <div class="flex items-center gap-4">
                <label class="w-16 font-medium text-gray-700">Reason</label>
                <textarea name="reason" class="w-96 border rounded-lg px-3 py-2 h-28 focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
            </div>
